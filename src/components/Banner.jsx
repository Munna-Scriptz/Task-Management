...
const Banner = () => {
  return (
    <>
        <section id='Banner' className='relative mt-[112px]'>
            <div className="container">
                <div id="Banner-Row" className='flex items-center justify-between'>
                    {/* ---------Banner Text--------- */}
                    <div>
                        <h1 className='text-[56px] text-gray900 w-[526px] font-extrabold leading-[130%]'>Task Management Assistant You Gonna Love</h1>
                        <p className='text-[18px] text-gray700 w-[526px] font-normal mt-[24px]'>We offer you a new generation of task management system. Plan, manage & track all your tasks in one flexible tool.</p>
                        {/* ---------Buttons--------- */}
                        ...
                        {/* ---------Brands--------- */}
                        <p className='text-gray900 text-base font-extrabold mt-[112px]'>Largest companies use our tool to work efficiently</p>
                    ...
                    {/* ---------Banner Image--------- */}
                    <div className='absolute top-[-120px] right-0 max-w-[1058px] min-w-[800px] w-[700px]'>
