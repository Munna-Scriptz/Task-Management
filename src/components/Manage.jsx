            ...
            <div className="container">
                <div id="Manage-Row" className='flex lg:flex-row flex-col items-center justify-between'>
                    ...
                    <div>
                        ...
                        <button className='flex items-center gap-2 text-white font-semibold hover:bg-gray300 hover:text-gray800 duration-[.3s] cursor-pointer py-[12px] px-[28px] bg-brand rounded-[6px] mt-[40px]'>Learn more<FaArrowRight /></button>
                    </div>
                </div>
            </div>
        </section>
