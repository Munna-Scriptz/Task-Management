            ...
            <div className="container">
                <div id="Pricing-Row">
                    ...
                    <div className='flex items-center justify-between mt-10'>
                        {/* -------------First Card------------- */}
                        <div className='w-[416px] p-10 border-1 border-gray300 rounded-[8px] flex items-center flex-col duration-[.3s] hover:shadow-lg shadow-[#6366F159]'>
                            ...
                            <div className='w-full'>
                                <ul className='flex flex-col gap-2'>
                                    <li className='text-gray700 text-sm font-normal flex items-center gap-[4px]'>
                        ...
                        {/* -------------Second Card------------- */}
                        <div className='relative w-[416px] p-10 border-1 border-gray300 rounded-[8px] flex items-center flex-col duration-[.3s] hover:shadow-lg shadow-[#6366F159]'>
